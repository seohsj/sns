...
-- PHOTO_ID  	CREATED_DATE  	LAST_MODIFIED_DATE  	CONTENT  	IMAGE_PATH  	USER_ID
 ...
 insert into photo (photo_id, content, image_path, user_id) values (7, 'content7', '#tagA#tagB#tagG#tagE', 7);
...
insert into tag(tag_id, name) values(6, 'tagF');
insert into tag(tag_id, name) values(7, 'tagG');
...
insert into photo_tag(photo_tag_id, photo_id, tag_id) values(11, 7, 1);
insert into photo_tag(photo_tag_id, photo_id, tag_id) values(12, 7, 2);
insert into photo_tag(photo_tag_id, photo_id, tag_id) values(13, 7, 5);
insert into photo_tag(photo_tag_id, photo_id, tag_id) values(14, 7, 7);
...
insert into comment(comment_id, user_id, content, photo_id) values(8, 1, 'comment8' ,7);
insert into comment(comment_id, user_id, content, photo_id) values(9, 3, 'comment9' ,7);
insert into mentioned_user(photo_user_id, mentioned_user_id, photo_id) values(1, 3, 3);
